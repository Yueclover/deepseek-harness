...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  desktopBridge: 'desktop.md',
  desktopInput: 'desktop.md',
  ...
  screenshot: 'desktop.md',
  screenshotTargets: 'desktop.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  DesktopBridgeEventMap: 'desktop.md',
  DesktopBridgeEventName: 'desktop.md',
  DesktopBridgeRequestName: 'desktop.md',
  DesktopInputEvent: 'desktop.md',
  InputActionHandler: 'desktop.md',
  InputActionId: 'desktop.md',
  InputBinding: 'desktop.md',
  RequestOf: 'desktop.md',
  ResponseOf: 'desktop.md',
  ScreenshotCaptureRequest: 'desktop.md',
  ScreenshotCaptureResult: 'desktop.md',
  ScreenshotImage: 'desktop.md',
  ScreenshotTarget: 'desktop.md',
  ScreenshotTargetId: 'desktop.md',
  ScreenshotTargetRequest: 'desktop.md',
